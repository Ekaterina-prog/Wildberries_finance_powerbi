...
# Какие бизнес-вопросы решает дашборд

### Дашборд отвечает на ключевые бизнес-вопросы:

- Какая выручка и прибыль по Wildberries
- Какие товары приносят наибольшую прибыль
- Какие товары показывают падение продаж
- Где высокая доля возвратов
- Какие регионы генерируют выручку
- Насколько бизнес рентабелен (ROI)
